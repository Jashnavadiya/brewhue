...
//       try {
//         const res = await axios.get('${process.env.REACT_APP_BASE_URL}/api/shops/enso');
//         setShop(res.data);
//       } catch (err) {
//         console.error(err);
//       }
...
//     try {
//       const res = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/shops/<shopId>/widgets`, newWidget);
...
//     try {
//       const res = await axios.put(`${process.env.REACT_APP_BASE_URL}/api/shops/<shopId>/widgets/${editWidget._id}`, editWidget);
//       setShop({
//         ...shop,
...
//     try {
//       await axios.delete(`${process.env.REACT_APP_BASE_URL}/api/shops/<shopId>/widgets/${widgetId}`);
//       setShop({
//         ...shop,
...
const ShopProfile = () => {
  ...
  useEffect(() => { 
    const fetchShopAndWidgets = async () => {
      try {
        // Fetch the shop info
        const shopRes = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/${shopName}/shop`);
  ...
  const handleAddWidget = async () => {
    try {
      const res = await axios.post(`${process.env.REACT_APP_BASE_URL}/api/${shopName}/widgets`, newWidget);
  ...
  const handleEditWidget = async () => {
    try {
      const res = await axios.put(`${process.env.REACT_APP_BASE_URL}/api/${shopName}/widgets/${editWidget._id}`, editWidget);
      setWidgets(
  ...
  const handleRemoveWidget = async (widgetId) => {
    try {
      await axios.delete(`${process.env.REACT_APP_BASE_URL}/api/${shopName}/widgets/${widgetId}`);
